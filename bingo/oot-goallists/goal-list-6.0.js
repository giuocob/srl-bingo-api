...
bingoListv6[1] = [
  ...
  { name: "Bottled Fish", jp: 'ビン(さかな)', types: ["bottle"], child: "yes" },
...
bingoListv6[2] = [
  ...
  { name: "Map & Compass in Deku Tree", jp: 'デクの樹サマの中のマップとコンパス', types: ["deku", "dungeon_item"], child: "yes" },
...
bingoListv6[3] = [
  ...
  { name: "Ruto's Letter", jp: 'ルト姫の手紙', types: ["ruto"], child: "yes" },
...
bingoListv6[5] = [
  ...
  { name: "Both heart pieces in Death Mountain Crater", jp: 'デスマウンテン火口のハートの欠片2個', types: ["dmc", "fire", "hearts"], child: "yes" },
...
bingoListv6[6] = [
  ...
  { name: "Beat the Deku Tree", jp: 'デクの樹サマの中クリア', types: ["deku", "ganon"], child: "yes" },
  ...
  { name: "All 3 Kokiri Forest area Skulltulas", jp: 'コキリの森エリアの黄金のスタルチュラ3匹', types: ["skulltula"], child: "no" },
...
bingoListv6[8] = [
  ...
  { name: "37th heart piece (Child Fortress)", jp: '37番目のハートの欠片(子供でゲルドの砦)', types: ["fortress"], child: "yes" },
...
bingoListv6[9] = [
  { name: "At least 7 Magic Beans", jp: '魔法の豆7つ以上', types: ["beans","skulltula"], child: "yes" },
  { name: "All 4 Lost Woods area Skulltulas", jp: '迷いの森エリアの黄金のスタルチュラ4匹', types: ["skulltula","forest"], child: "no" },
  { name: "Ice Cavern Heart Piece", jp: '氷の洞窟のハートの欠片', types: ["ice"], child: "yes" },
...
bingoListv6[10] = [
  ...
  { name: "Both Gerudo's Fortress area Skulltulas", jp: 'ゲルドの砦エリアの黄金のスタルチュラ2匹', types: ["skulltula", "fortress"], child: "no" },
  { name: "All 4 Skulltulas in Deku Tree", jp: 'デクの樹サマの中の黄金のスタルチュラ4匹', types: ["deku", "skulltula"], child: "yes" },
...
bingoListv6[11] = [
  ...
  { name: "Plant bean in Death Mountain Crater", jp: 'デスマウンテン火口の土に豆を植える', types: ["dmc", "beans"], child: "yes" },
...
bingoListv6[12] = [
  ...
  { name: "Get Bombchu chest in Spirit Temple", jp: '魂の神殿の宝箱からボムチュウ取得', types: ["spirit", "strength"], child: "yes" }
];
bingoListv6[13] = [
...
bingoListv6[14] = [
  { name: "At least 9 Magic Beans", jp: '魔法の豆9つ以上', types: ["beans","skulltula"], child: "yes" },
...
bingoListv6[16] = [
  ...
  { name: "Defeat Amy (Green Poe)", jp: 'エイミー(緑色のポウ)撃破', types: ["forest", "quiver"], child: "no" },
  ...
  { name: "Treasure Chest Game Heart Piece", jp: '宝箱ゲームのハートの欠片', types: ["zl", "luck"], child: "yes" },
  { name: "All 8 Kakariko area Skulltulas", jp: 'カカリコ村エリアの黄金のスタルチュラ8匹', types: ["skulltula", "botw"], child: "no" }
];
bingoListv6[17] = [
  { name: "Both heart pieces in Lost Woods", jp: '迷いの森のハートピースの両方', types: ["strength" ,"masks", "songs", "zl"], child: "yes" },
  ...
  { name: "Prescription", jp: '処方せん', types: ["atrade"], child: "no" },
...
bingoListv6[19] = [
  ...
  { name: "Bombchu Bowling Heart Piece", jp: 'ボムチュウボウリングのハートの欠片', types: ["dc"], child: "yes" },
...
bingoListv6[20] = [
  { name: "Defeat Meg (purple Poe)", jp: 'メグ(紫色のポウ)撃破', types: ["forest", "quiver"], child: "no" },
...
bingoListv6[21] = [
  { name: "8 unused keys in Gerudo Training Grounds", jp: 'ゲルドの修練場の未使用のカギ7つ', types: ["fortress"], child: "no" },
...
bingoListv6[23] = [
  ...
  { name: "Get to the end of the Forest Trial", jp: '', types: ["ganon", "zl"], child: "no" },
...
bingoListv6[24] = [
  ...
  { name: "Frog's Heart Piece", jp: 'カエルのハートの欠片', types: ["songs", "forest"], child: "no" },
  ...
  { name: "All 5 Lake Hylia Skulltulas", jp: 'ハイリア湖畔の黄金のスタルチュラ5匹', types: ["ice", "skulltula", "water"], child: "no" }
];
bingoListv6[25] = [
  { name: "9 unused keys in Gerudo Training Grounds", jp: 'ゲルドの修練場の未使用のカギ7つ', types: ["fortress","ice"], child: "no" },
  ...
  { name: "Biggoron’s Sword", jp: "", types: ["atrade", "sets", "claimcheck"], child: "no"},
  ...
  { name: "7 Maps", jp: '', types: ["dungeon_item", "claimcheck"], child: "no" },
  { name: "7 Compasses", jp: '', types: ["dungeon_item"], child: "no" },
  { name: "3 Swords, Tunics, Boots, and Shields", jp: '', types: ["sets","spirit","ice"], child: "no"},
  { name: "4 Boss Keys", jp: 'ボス部屋のカギ4つ', types: ["dungeon_item", "claimcheck"], child: "no" },
  { name: "10 Hearts", jp: '', types: ["hearts"], child: "yes" },
  { name: "Ocarina of Time", jp: '時のオカリナ', types: ["atrade", "forest", "deku", "dc", "jabu"], child: "yes" }
];

module.exports = bingoListv6;